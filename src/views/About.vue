      ...
      <div class="section-content">
        ...
        <div class="row">
          <div class="col-xs-12 col-sm-7">
            <p>
              Proin volutpat mauris ac pellentesque pharetra. Suspendisse congue elit vel
              odio suscipit, sit amet tempor nisl imperdiet. Quisque ex justo, faucibus ut
              mi in, condimentum finibus dolor. Aliquam vitae hendrerit dolor, eget
              imperdiet mauris. Maecenas et ante id ipsum condimentum dictum et vel massa.
            ...
            <div class="info-list">
              <ul>
                ...
                <li>
                  ...
                  <span class="value">aixinaihongjun@gmail.com</span>
                </li>

                <li>
                  <span class="title">Phone</span>
                  <span class="value">155-4610-0773</span>
                </li>
              </ul>
            </div>
          </div>
          ...
          <div class="col-xs-12 col-sm-12">
            <div class="testimonials owl-carousel">
              ...
              <div class="testimonial">
                <div class="img">
                  <img src="../assets/images/testimonial-1.jpg" alt="Alex Smith" />
                </div>
                <div class="text">
                  <p>
              ...
              <div class="testimonial">
                <div class="img">
                  <img src="../assets/images/testimonial-2.jpg" alt="Alex Smith" />
                </div>
                <div class="text">
                  <p>
                    Vivamus at molestie dui, eu ornare orci. Curabitur vel egestas dolor.
              ...
              <div class="testimonial">
                <div class="img">
                  <img src="../assets/images/testimonial-3.jpg" alt="Alex Smith" />
                </div>
                <div class="text">
                  <p>
                    Vivamus at molestie dui, eu ornare orci. Curabitur vel egestas dolor.
